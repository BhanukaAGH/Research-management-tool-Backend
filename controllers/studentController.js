...
const getStudentgroups=async(req,res)=>{//get all student groups
  try {
...
const getOneGroup=async(req,res)=>{//get one group details
  try {
...
const Allocate=async(req,res)=>{//patch to allocate panel members
